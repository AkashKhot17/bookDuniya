...
const Banner = () => {
  return(
    <>
    <div className="max-w-screen-2xl mx-auto px-4 md:px-20 container flex flex-col md:flex-row gap-14">
  ...
  <input type="text" className="grow" placeholder="Email" />
          ...
          <button className="btn btn-active btn-secondary mt-5">Secondary</button>
